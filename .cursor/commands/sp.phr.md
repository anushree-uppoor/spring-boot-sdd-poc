...
Optional: if **`roam_*` tools** are available and the recorded session referenced the codebase, you **MAY** add one line to `RESPONSE_TEXT` or metadata noting Roam usage; otherwise omit. No hard requirement for PHR.
